   ...
   return(
      <HomeLayout>
        <div className="flex items-center justify-center h-[84vh]" >
            <form  noValidate onSubmit={createNewAccount} className="flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-90 shadow-[0_0_10px_black]" >
                ...
                <label htmlFor = "image_uploads" className="cursor-pointer">
                    {previewImage ? (
                        ...
                        <BsPersonCircle className="w-24 h-24 rounded-full m-auto text-gray-300"/>
                    )}
                </label>
                <input 
                className="hidden"
